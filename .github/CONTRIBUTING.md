...
- 💬 Join our [discussions](https://github.com/petitmonde/petitmonde/discussions)
- 📋 Use [issue templates](https://github.com/petitmonde/petitmonde/issues/new/choose) to report bugs or request features
- 📖 Read our [Code of Conduct](https://github.com/petitmonde/petitmonde/blob/main/CODE_OF_CONDUCT.md)
